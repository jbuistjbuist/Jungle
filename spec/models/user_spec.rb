...
RSpec.describe User, type: :model do
  ...
  describe "Validations - Registration" do
    ...
    it "registers a user if all the correct fields are present" do
      expect {
        User.create!(first_name: "Jeremy", last_name: "Buist", email: "jeremy@jeremy.com", password: "password", password_confirmation: "password")
  ...
  context "Password" do
    ...
    it "gives appropriate error if password confirmation is not present" do
      @user = User.create(first_name: "Jeremy", last_name: "Buist", email: "jeremy@jeremy.com", password: "password")
    ...
    it "gives appropriate error if password confirmation does not match password" do
      @user = User.create(first_name: "Jeremy", last_name: "Buist", email: "jeremy@jeremy.com", password: "password", password_confirmation: "paswordd")
      expect(@user.errors.full_messages).to_not be_empty
    ...
    it "gives appropriate error if password is less than 8 characters" do
      @user = User.create(first_name: "Jeremy", last_name: "Buist", email: 'jeremy@jeremy.com', password: "passwor", password_confirmation: "passwor")
      expect(@user.errors.full_messages).to_not be_empty
  ...
  context "Email" do 
    ...
    it "gives appropriate error if email not present" do
      @user = User.create(first_name: "Jeremy", last_name: "Buist", email: nil, password: "password", password_confirmation: "password")
      expect(@user.errors.full_messages).to_not be_empty
    ...
    it "gives appropriate error if email already exists (not case sensitive)" do
      User.create(first_name: "Jay", last_name: "B", email: "jeremy@jeremy.com", password: "password", password_confirmation: "password")
      @user = User.create(first_name: "Jeremy", last_name: "Buist", email: "JEREMY@jeremy.com", password: "password", password_confirmation: "password")
      expect(@user.errors.full_messages).to_not be_empty
    ...
    it "gives appropriate error if last name not present" do
      @user = User.create(first_name: "Jeremy", last_name: nil, email: 'jeremy@jeremy.com', password: "password", password_confirmation: "password")
      expect(@user.errors.full_messages).to_not be_empty
    ...
    it "gives appropriate error if first name not present" do
      @user = User.create(first_name: nil, last_name: "Buist", email: 'jeremy@jeremy.com', password: "password", password_confirmation: "password")
      expect(@user.errors.full_messages).to_not be_empty
  ...
  describe ".authenticate_with_credentials" do 
    ...
    it "returns the correct user object given the needed information" do
      expect(User.authenticate_with_credentials("jeremy@jeremy.com", "password")).to eql(User.last)
    end

    it "returns nil if the email is not found" do
      expect(User.authenticate_with_credentials("jeremy@jer.com", "password")).to be_nil
    end

    it "returns nil if the password is incorrect" do
      expect(User.authenticate_with_credentials("jeremy@jeremy.com", "passwor")).to be_nil
    end
