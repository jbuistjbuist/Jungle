...
RSpec.describe Product, type: :model do
  ...
  describe 'Validations' do
    it "saves the model if all fields are present" do 
      expect {
        Product.create!(name: "Fun Fern", description: "this is a fun fern", price: 10, quantity: 15, category: Category.last)
      }.to change { Product.count }
    end

    it "adds appropriate error if name not provided" do 
      @product = Product.create(name: nil, description: "this is a fun fern", price: 10, quantity: 15, category: Category.last)
    ...
    it "adds appropriate error if price not provided" do 
      @product = Product.create(name: "Fun Fern", description: "this is a fun fern", quantity: 15, category: Category.last)
      expect(@product.errors.full_messages).not_to be_empty
    ...
    it "adds appropriate error if quantity not provided" do 
      @product = Product.create(name: "Fun fern", description: "this is a fun fern", price: 10, quantity: nil, category: Category.last)
      expect(@product.errors.full_messages).not_to be_empty
    ...
    it "adds appropriate error if category not provided" do 
      @product = Product.create(name: "Fun fern", description: "this is a fun fern", price: 10, quantity: 25, category: nil)
      expect(@product.errors.full_messages).not_to be_empty
